...
<?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
        ...
        <li class="nav-item dropdown">
          ...
          <?php }?>
            <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
                 <li class="nav-item">
            <a class="nav-link" target="_blank" href="https://www.justdial.com/Bangalore/Tech-Tune-Motors-Near-Double-Road-Essar-Petrol-Bunk-Rajarajeshwari-Nagar/080PXX80-XX80-180411171602-G7Q5_BZDET"><i class="fa fa-info-circle"></i> About Author</a>
          </li>
          <?php }?>
        </ul>
      </div>
